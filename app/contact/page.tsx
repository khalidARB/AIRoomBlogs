...
import { getAllPosts, getCategories, getMenu } from '@/lib/wordpress';
import {
  Mail,
  MapPin,
  Clock,
...
export const metadata: Metadata = {
  title: 'Contact Us — AiRooms',
  description:
    'Get in touch with the AiRooms team regarding technical publications, headless WordPress architecture, press, and editorial partnerships.',
};
